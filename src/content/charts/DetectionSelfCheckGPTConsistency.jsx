...
function DetectionSelfCheckGPTConsistency({ data }) {
  ...
  return data ? (
    <ChartContainer className="min-h-40 w-full py-4" config={{}} ref={ref}>
      <div className="w-full flex flex-row justify-center items-center">
        <span>
          SelfCheckGPT Evaluation Self-Consistency: Score Distribution
        </span>
      </div>
      <BarChart
        accessibilityLayer
...
export default DetectionSelfCheckGPTConsistency;
